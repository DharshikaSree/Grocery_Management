...
// // Add a new column `quantity` to the `transaction` table
// $sql = "ALTER TABLE transaction ADD COLUMN quantity INT DEFAULT 1";
...
// $vn = $conn3->prepare("INSERT INTO transaction(name, email, items, paid, quantity) VALUES (?,?,?,?,?)");
// $vn->bind_param("sssssi", $nme, $rowv["EMAIL"], $itemsc, $cost, $quantity);
// $vn->execute();
// $vn->close();
